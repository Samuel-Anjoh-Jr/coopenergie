        ...
        <Card className="w-full max-w-md border-border/50 shadow-2xl bg-card/80 backdrop-blur">
          ...
          <CardContent className="space-y-4 pt-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    id="email"
                    type="email"
                    placeholder="jean@coopenergie.cm"
                    value={email}
            ...
            <div className="pt-4 border-t border-border">
              ...
              <div className="bg-muted/50 rounded-lg p-3 space-y-1 text-xs text-muted-foreground font-mono">
                <p>jean@coopenergie.cm / jean123</p>
                <p>marie@coopenergie.cm / marie123</p>
                <p>pierre@coopenergie.cm / pierre123</p>
                <p>amara@coopenergie.cm / amara123</p>
                <p>sophie@coopenergie.cm / sophie123</p>
              </div>
            </div>
          </CardContent>
        </Card>
